  ...
  return (
    <div className='header bg-blue-900'>
        ...
        <div className="header-content flex lg:flex-row flex-col items-center">
            <img src="https://show.moxcreative.com/virtuware/wp-content/uploads/sites/39/2021/12/multidevice_mockup_1.png" alt="devices" className='lg:w-[55%] w-[100%]' />
            <div className="content text-white flex flex-col justify-center px-4 text-center md:text-left ">
                ...
                <div className="download-btn mt-4 flex gap-2 justify-center md:justify-evenly">
